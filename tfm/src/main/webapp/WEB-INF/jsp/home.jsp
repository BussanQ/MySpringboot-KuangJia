...
<!DOCTYPE html>
<script type="text/javascript" src="/Alpha/static/js/jquery_min_2_1_4.js"></script>
<script type="text/javascript" src="/Alpha/static/js/amazeui.min.js"></script>
<script type="text/javascript" src="/Alpha/static/js/app.js"></script>
<script type="text/javascript" src="/Alpha/static/js/blockUI.js"></script>
<script type="text/javascript" src="/Alpha/static/js/charts/echarts.min.js"></script>
<script type="text/javascript" src="/Alpha/static/js/charts/indexChart.js"></script>
<script type="text/javascript" src="/Alpha/static/js/jquery.ajaxfileupload.js"></script>
...
<head>
    ...
    <link rel="stylesheet" href="/Alpha/static/css/amazeui.css" />
    <link rel="stylesheet" href="/Alpha/static/css/core.css" />
    <link rel="stylesheet" href="/Alpha/static/css/menu.css" />
    <link rel="stylesheet" href="/Alpha/static/css/index.css" />
    <link rel="stylesheet" href="/Alpha/static/css/admin.css" />
    <link rel="stylesheet" href="/Alpha/static/css/page/typography.css" />
    <link rel="stylesheet" href="/Alpha/static/css/page/form.css" />
    <link rel="stylesheet" href="/Alpha/static/css/component.css" />
</head>
        ...
        <ul class="am-nav am-navbar-nav am-navbar-right">
            ...
            <li class="hidden-xs am-hide-sm-only">
                <form role="search" class="app-search">
                    ...
                    <a href=""><img src="/Alpha/static/images/search.png"></a>
                </form>
            </li>
        </ul>
    </div>
    ...
    <div class="admin-sidebar am-offcanvas  am-padding-0" id="admin-offcanvas">
        <div class="am-offcanvas-bar admin-offcanvas-bar">
            ...
            <div class="user-box am-hide-sm-only">
                <div class="user-img">
                    <img src="/Alpha/static/images/avatar-1.jpg" alt="user-img" title="Mat Helme" class="img-circle img-thumbnail img-responsive" onclick="changeUserInfo()">
            ...
            <ul class="am-list admin-sidebar-list">
                ...
                <li class="admin-parent">
                    ...
                    <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav1">
                        <li>
                            <a href="/Alpha/static/view/table_basic.html" class="am-cf"> 基本表格</a>
                        </li>
                        <li>
                            <a href="/Alpha/static/view/table_complete.html">完整表格</a>
                        </li>
                    </ul>
                </li>
                <li class="admin-parent">
                    ...
                    <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav2">
                        <li>
                            <a href="/Alpha/static/view/chart_line.html" class="am-cf"> 折线图</a>
                        </li>
                        <li>
                            <a href="/Alpha/static/view/chart_columnar.html" class="am-cf"> 柱状图</a>
                        </li>
                        <li>
                            <a href="/Alpha/static/view/chart_pie.html" class="am-cf"> 饼状图</a>
                        </li>
                    </ul>
                </li>
                <li class="admin-parent">
                    ...
                    <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav5">
                        ...
                        <li>
                            <a href="/Alpha/static/view/form_validate.html">表单验证</a>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="am-g">
                ...
                <div class="am-u-md-3">
                    <div class="card-box widget-user">
                        <div>
                            <img src="/Alpha/static/images/avatar-3.jpg" class="img-responsive img-circle" alt="user">
                ...
                <div class="am-u-md-3">
                    <div class="card-box widget-user">
                        <div>
                            <img src="/Alpha/static/images/avatar-2.jpg" class="img-responsive img-circle" alt="user">
                ...
                <div class="am-u-md-3">
                    <div class="card-box widget-user">
                        <div>
                            <img src="/Alpha/static/images/avatar-4.jpg" class="img-responsive img-circle" alt="user">
                ...
                <div class="am-u-md-3">
                    <div class="card-box widget-user">
                        <div>
                            <img src="/Alpha/static/images/avatar-10.jpg" class="img-responsive img-circle" alt="user">
                        ...
                        <div class="inbox-widget nicescroll" style="height: 315px; overflow: hidden; outline: none;" tabindex="5000">
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="/Alpha/static/images/avatar-1.jpg" class="img-circle" alt=""></div>
                            ...
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="/Alpha/static/images/avatar-2.jpg" class="img-circle" alt=""></div>
                            ...
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="/Alpha/static/images/avatar-10.jpg" class="img-circle" alt=""></div>
                            ...
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="/Alpha/static/images/avatar-4.jpg" class="img-circle" alt=""></div>
                            ...
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="/Alpha/static/images/avatar-5.jpg" class="img-circle" alt=""></div>
