...
<script type="text/javascript" src="/Alpha/static/js/jquery-3.1.1.min.js"></script>
<script type="text/javascript" src="/Alpha/static/js/jquery.tips.js"></script>
<script type="text/javascript" src="/Alpha/static/js/login.js"></script>
<script type="text/javascript">
    ...
    function load() {
    	 $.ajax({
             type: "POST",
             url: '<%=request.getContextPath()%>/weixin/load',
             data: {echostr: "ok",si:"123"},
             dataType: 'text',   //当这里指定为json的时候，获取到了数据后会自己解析的，只需要 返回值.字段名称 就能使用了
             cache: false,
...
<head>
    ...
    <link href="/Alpha/static/css/login2.css" rel="stylesheet" type="text/css"/>
</head>
<html>
<body>
